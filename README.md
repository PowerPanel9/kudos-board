...
We did not have labs this week, but the previous labs have covered frontend and backend separately. Our job this week was just to bring the ideas together and build a full-stack web app. We did not feel unprepared as we've had ample practice with both ends.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

If we had more time we would have added the mode switch feature, to allow the user to switch between light and dark mode.
...
Shoutout to my teammates they worked hard and contributed to making the project successful.